...
wget -q -O $TMP_DIR/download/linux-amd64.tar.gz   https://github.com/$REPO/releases/download/v${VERSION}/vultr-cli_v${VERSION}_linux_amd64.tar.gz
wget -q -O $TMP_DIR/download/linux-arm64.tar.gz   https://github.com/$REPO/releases/download/v${VERSION}/vultr-cli_v${VERSION}_linux_arm64.tar.gz
wget -q -O $TMP_DIR/download/macos-amd64.tar.gz   https://github.com/$REPO/releases/download/v${VERSION}/vultr-cli_v${VERSION}_macOs_amd64.tar.gz
wget -q -O $TMP_DIR/download/macos-arm64.tar.gz   https://github.com/$REPO/releases/download/v${VERSION}/vultr-cli_v${VERSION}_macOs_arm64.tar.gz
wget -q -O $TMP_DIR/download/windows-amd64.zip    https://github.com/$REPO/releases/download/v${VERSION}/vultr-cli_v${VERSION}_windows_amd64.zip
wget -q -O $TMP_DIR/download/windows-arm64.zip    https://github.com/$REPO/releases/download/v${VERSION}/vultr-cli_v${VERSION}_windows_arm64.zip
