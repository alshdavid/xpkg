...
wget -q -O $TMP_DIR/download/linux-amd64.tar.gz   https://go.dev/dl/go$VERSION.linux-amd64.tar.gz
wget -q -O $TMP_DIR/download/linux-arm64.tar.gz   https://go.dev/dl/go$VERSION.linux-arm64.tar.gz
wget -q -O $TMP_DIR/download/macos-amd64.tar.gz   https://go.dev/dl/go$VERSION.darwin-amd64.tar.gz
wget -q -O $TMP_DIR/download/macos-arm64.tar.gz   https://go.dev/dl/go$VERSION.darwin-arm64.tar.gz
wget -q -O $TMP_DIR/download/windows-amd64.zip    https://go.dev/dl/go$VERSION.windows-amd64.zip
wget -q -O $TMP_DIR/download/windows-arm64.zip    https://go.dev/dl/go$VERSION.windows-arm64.zip

echo "EXTRACTING"
mkdir $TMP_DIR/binaries        
8zip extract --strip-components 1 --output $TMP_DIR/binaries/$PACKAGE-$VERSION-linux-amd64   $TMP_DIR/download/linux-amd64.*
8zip extract --strip-components 1 --output $TMP_DIR/binaries/$PACKAGE-$VERSION-linux-arm64   $TMP_DIR/download/linux-arm64.*
8zip extract --strip-components 1 --output $TMP_DIR/binaries/$PACKAGE-$VERSION-macos-amd64   $TMP_DIR/download/macos-amd64.*
8zip extract --strip-components 1 --output $TMP_DIR/binaries/$PACKAGE-$VERSION-macos-arm64   $TMP_DIR/download/macos-arm64.*
8zip extract --strip-components 1 --output $TMP_DIR/binaries/$PACKAGE-$VERSION-windows-amd64 $TMP_DIR/download/windows-amd64.*
8zip extract --strip-components 1 --output $TMP_DIR/binaries/$PACKAGE-$VERSION-windows-arm64 $TMP_DIR/download/windows-arm64.*
